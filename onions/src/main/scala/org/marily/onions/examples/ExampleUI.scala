package org.marily.onions.examples

import java.util.{Timer, TimerTask}

import org.marily.onions.{Palettes, Themes}
import org.marily.onions.components.Frame
import org.marily.onions.components.widgets._
import org.marily.onions.utils.{Lorem, TextWrap, Varying}
import org.marily.scurses.{Colors, Scurses}
import org.marily.scurses.RichText._
...
//    RichLabel(colA, r"${Lorem.Ipsum}")
    ...
    colB.addTab()
    BitMap(colB, "/onions/src/main/resources/logo.png", relative = true)
    Separator(colB)
